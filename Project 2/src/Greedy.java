...
public class Greedy {
    ...
    public static void storeFolders(ListInterface<Integer> files){
        ...
        int numOfDisksUn= 1; //stores the total number of disks, also it is the id of every disk
        pqUnsorted.add(new Disk(numOfDisksUn));
        int totalSumUn = 0; //total size of all folders
        ...
        try {
            ...
            while (!files.isEmpty()) {
                ...
                } else { //the size of the current folder does not fit in the disk
                    numOfDisksUn++;
            ...
            //while loop for the sorted list
